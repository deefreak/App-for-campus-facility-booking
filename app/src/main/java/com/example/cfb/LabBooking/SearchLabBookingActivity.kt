...
class SearchLabBookingActivity : AppCompatActivity() {
    ...
    private fun fetchToDoList() {
        doAsync {
            ...
            fireStore.collection("BookingHistory").whereEqualTo("bookedBy",auth.currentUser.email).whereEqualTo("type","Labs").get()
