...
class SearchSportsBookingActivity : AppCompatActivity() {
    ...
    private fun fetchToDoList() {
        doAsync {
            ...
            fireStore.collection("BookingHistory").whereEqualTo("bookedBy",auth.currentUser.email).whereEqualTo("type","Sports").get()
